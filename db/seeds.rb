...
ApplicationRecord.transaction do 
    ...
    j = Artist.create!(name: "J. Cole", description: "J. Cole is an American rapper, singer, and songwriter known for his introspective lyrics and socially conscious themes.")
